...
class SoftmaxModel(Model):
    ...
    def add_placeholders(self):
        ...
        ### YOUR CODE HERE
        conf = self.config
        self.input_placeholder = tf.placeholder(tf.float32, shape = (conf.batch_size, conf.n_features))
        self.output_placeholder = tf.placeholder(tf.int32, shape = (conf.batch_size, conf.n_classes))
        ### END YOUR CODE
    ...
    def add_prediction_op(self):
        ...
        ### YOUR CODE HERE
        conf = self.config
        batch_size, n_features = conf.batch_size, conf.n_features
        W = tf.Variable(tf.zeros([n_features, conf.n_classes]), name = "weights")
        b = tf.Variable(tf.zeros([conf.n_classes]), name = "bias")
    ...
    def add_loss_op(self, pred):
        ...
        """
        ### YOUR CODE HERE
        loss = cross_entropy_loss(self.output_placeholder, pred)
        ### END YOUR CODE
        return loss
    ...
    def add_training_op(self, loss):
        ...
        ### YOUR CODE HERE
        conf = self.config
        train_op = tf.train.GradientDescentOptimizer(conf.lr).minimize(loss)
        ### END YOUR CODE
        return train_op
